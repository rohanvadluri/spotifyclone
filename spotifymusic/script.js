...
// }
// 
// for netlify deploy getsongs()-function from gpt
// songs fetched by lowercase(mp3files and folders(optional)) 
// and info.json
async function getsongs(folder) {
    currfolder = folder;
...
// use/works locally but not works when its deployed in netlify
...
// displayalbums()-fun by gpt-to run in netlify
// we manually entered the folder names
// displayalbums()-->code rectified by chat GPT
// 
async function displayalbums() {
    let cardconainer = document.querySelector(".cardcontainer");

    // List of your music folders
    let folders = ["Anirudh_Ravichander","arijit_singh","arrahman","A_aaaDivine","A_Devi_sri_prasad","A_keeravani","A_manisharma","A_shreya","A_sidsriram","A_spb","A_Yo_Yo_Honey_Singh","Bright_(mood)","b_karthik","b_thaman","cs","c_ilayaraja","d_private_songs","favourite_songs","hindi","ncs","ost",];
 // Add more folders like "ncs", "cs", etc.
